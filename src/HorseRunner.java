public class HorseRunner {
    public static void main(String[] args)
    {
        ...
        System.out.println(" Dusty Trail is in space: " + barn.findHorseSpace("Dusty Trial"));

        barn.consolidate();

        System.out.println(barn);
        System.out.println(" Dusty Trail is now in space: " + barn.findHorseSpace("Duty Trail"));
    }
}
